...
% Initial conditions associate with time point, t = 0.5
time_initial_distribution = 0.5;
tspan = linspace(time_initial_distribution,20.0,40);
%tspan = linspace(time_initial_distribution,100.0,2);



init_prob_st_1 = 0.4444214606992278 ;
init_prob_st_2 = 4.495588271175256E-5 ;
init_prob_st_3 = 0.44441096802555125 ;
init_prob_st_4 = 1.1361564574392534E-9 ;
init_prob_st_5 = 2.247793336647599E-5;
init_prob_st_6 = 0.11110008716454593 ;

u_con_E_Clients_Client_think_st_1 = 52.00302614190912 ;
init_con_E_Clients_Client_think_st_1 =  ( u_con_E_Clients_Client_think_st_1 )  /  ( init_prob_st_1 )  ; 

u_con_E_Clients_Client_req_st_1 = 14.660192962974994 ; 
init_con_E_Clients_Client_req_st_1 =  ( u_con_E_Clients_Client_req_st_1 )  /  ( init_prob_st_1 )  ; 



u_con_E_Clients_Client_think_st_2 = 0.004569590646495226 ; 
init_con_E_Clients_Client_think_st_2 =  ( u_con_E_Clients_Client_think_st_2 )  /  ( init_prob_st_2 )  ; 

u_con_E_Clients_Client_req_st_2 = 0.0021737917602676596  ; 
init_con_E_Clients_Client_req_st_2 =  ( u_con_E_Clients_Client_req_st_2 )  /  ( init_prob_st_2 )  ; 



u_con_E_Clients_Client_think_st_3 = 52.29633502996408 ;
init_con_E_Clients_Client_think_st_3 =  ( u_con_E_Clients_Client_think_st_3 )  /  ( init_prob_st_3 )  ; 

u_con_E_Clients_Client_req_st_3 = 14.365310173868576 ;
init_con_E_Clients_Client_req_st_3 =  ( u_con_E_Clients_Client_req_st_3 )  /  ( init_prob_st_3 )  ; 



u_con_E_Clients_Client_think_st_4 = 9.802960234816651E-8 ;
init_con_E_Clients_Client_think_st_4 =  ( u_con_E_Clients_Client_think_st_4 )  /  ( init_prob_st_4 )  ; 

u_con_E_Clients_Client_req_st_4 = 7.239386626772125E-8 ;
init_con_E_Clients_Client_req_st_4 =  ( u_con_E_Clients_Client_req_st_4 )  /  ( init_prob_st_4 )  ; 



u_con_E_Clients_Client_think_st_5 = 0.0022997086907226173 ;
init_con_E_Clients_Client_think_st_5 =  ( u_con_E_Clients_Client_think_st_5 )  /  ( init_prob_st_5 )  ; 

u_con_E_Clients_Client_req_st_5 = 0.0010719813142487775 ;
init_con_E_Clients_Client_req_st_5 =  ( u_con_E_Clients_Client_req_st_5 )  /  ( init_prob_st_5 )  ; 



u_con_E_Clients_Client_think_st_6 = 13.147404464364316;
init_con_E_Clients_Client_think_st_6 =  ( u_con_E_Clients_Client_think_st_6 )  /  ( init_prob_st_6 )  ; 

u_con_E_Clients_Client_req_st_6 = 3.517608610317552 ;
...
options=odeset('Mass',@mass,'RelTol',0.1,'AbsTol',[1.0E-1 1.0E-1 1.0E-1 1.0E-1 1.0E-1 1.0E-1 1.0E-1 1.0E-1 1.0E-1 1.0E-1 1.0E-1 1.0E-1 1.0E-1 1.0E-1 1.0E-1 1.0E-1 1.0E-1 1.0E-1 ], 'Stats', 'on');

start = cputime; 
[t,y] = ode15s(@derivatives,tspan,y0,options);
duration = cputime-start;
duration
% correct the time with respect to the initial time specified above. 
...
csvwrite('MCM_Analysis_Output/prob_st_1.dat',output);

for i=1:length(t)
	output(i,2) = y(i,2);
end
csvwrite('MCM_Analysis_Output/prob_st_2.dat',output);

for i=1:length(t)
	output(i,2) = y(i,3);
end
csvwrite('MCM_Analysis_Output/prob_st_3.dat',output);

for i=1:length(t)
	output(i,2) = y(i,4);
end
csvwrite('MCM_Analysis_Output/prob_st_4.dat',output);

for i=1:length(t)
	output(i,2) = y(i,5);
end
csvwrite('MCM_Analysis_Output/prob_st_5.dat',output);

for i=1:length(t)
	output(i,2) = y(i,6);
end
csvwrite('MCM_Analysis_Output/prob_st_6.dat',output);
